#ifndef LIBKEPLER_SIMD4D_H
#define LIBKEPLER_SIMD4D_H
...
static inline vec4d dot(vec4d a, vec4d b) {
    return splat4d(a[0]*b[0] + a[1]*b[1] + a[2]*b[2] + a[3]*b[3]);
}
...
static inline vec4d mag(vec4d a) {
