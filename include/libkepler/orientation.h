#ifndef LIBKEPLER_ORIENTATION_H
#define LIBKEPLER_ORIENTATION_H
...
static inline double orientation_longitude_of_ascending_node(
    ...
    if(dot(nodes, nodes)[0] < DBL_EPSILON) // equatorial orbit
        return 0.0;
